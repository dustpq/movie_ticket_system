...
public class movie2_info {
        ...
        reserveSeatsButton.addActionListener(e -> {
            ...
            if (isGuest) {
                ...
                if (a600pmRadioButton.isSelected()) {
                    ...
                    try {
                        FileWriter writer = new FileWriter("src/resources/movie2_600pm.txt", true);
                    ...
                    try {
                        FileWriter writer = new FileWriter("src/resources/movie2_800pm.txt", true);
                        writer.write("Seats reserved: ");
                        for (Component component : time2.getComponents()) {
                            if (component instanceof JCheckBox) {
                                if (((JCheckBox) component).isSelected()) {
    ...
    public boolean isSeatReserved(String seat, String showTime) {
        ...
        if (showTime.equals("600pm")) {
            filename = "src/resources/movie2_600pm.txt";
        } else if (showTime.equals("800pm")) {
            filename = "src/resources/movie2_800pm.txt";
        }
